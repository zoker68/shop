                ...
                <div class="w-full xl:w-5/6 max-w-full xl:px-3">
                    <div class="sm:flex justify-center">
                        <div class="w-[270px] sm:w-1/3 max-w-full sm:pr-3 mb-3 sm:mb-0 mx-auto">
                            <div class="min-h-[90px] border border-primary rounded-sm flex items-center justify-center">
                                <div class="mr-3 md:mr-6 flex-shrink-0">
                                    <img src="assets/images/delivery-van.svg" class="w-[40px] md:w-[50px] max-h-11"
                                         alt="icon">
                                </div>
                                <div>
                        ...
                        <div class="w-[270px] sm:w-1/3 max-w-full sm:px-3 mb-3 sm:mb-0 mx-auto">
                            <div class="min-h-[90px] border border-primary rounded-sm flex items-center justify-center">
                                <div class="mr-3 md:mr-6 flex-shrink-0">
                                    <img src="assets/images/money-back.svg" class="w-[40px] md:w-[50px] max-h-11"
                                         alt="icon">
                                </div>
                                <div>
                        ...
                        <div class="w-[270px] sm:w-1/3 max-w-full sm:pl-3 mx-auto">
                            <div class="min-h-[90px] border border-primary rounded-sm flex items-center justify-center">
                                <div class="mr-3 md:mr-6 flex-shrink-0">
                                    <img src="assets/images/service-hours.svg" class="w-[40px] md:w-[50px] max-h-11"
                                         alt="icon">
                                </div>
                                <div>
        ...
        <div class="container">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                <div class="col-span-1 pr-3">
                    <h4 class="text-[20px] sm:text-lg font-medium mt-7">Watch</h4>
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img loading="lazy" src="assets/images/apple-watch.png"
                                     class="w-full h-[75px] object-contain flex-shrink-0" alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">1</span>
                        </div>
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">Apple Watch </h4>
                            </a>
                            <div class="font-medium">
                                <span class="text-primary mr-1">$200.00</span>
                                <span class="text-[#687188] text-sm font-medium line-through">$300.45</span>
                            </div>
                            <div>
                                <div class="flex items-center justify-start">
                                    <div class="flex items-center">
                                        <span class="text-[#F6BC3E]"><svg width="15" height="15" viewBox="0 0 24 24">
                                    ...
                                    <p class="text-xs ml-2 text-[#687188]">(150)</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img src="assets/images/watch2.png" class="w-full h-[75px] object-contain flex-shrink-0"
                                     alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">2</span>
                        </div>
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">Callie Smartwatch</h4>
                            </a>
                            <div class="font-medium">
                                <span class="text-primary mr-1">$150.00</span>
                                <span class="text-[#687188] text-sm font-medium line-through">$200.45</span>
                            </div>
                            <div>
                                <div class="flex items-center justify-start">
                                    <div class="flex items-center">
                    ...
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img src="assets/images/watch3.png" class="w-full h-[75px] object-contain flex-shrink-0"
                                     alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">3</span>
                        </div>
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">Cruz Smartwatch</h4>
                            </a>
                            <div class="font-medium">
                ...
                <div class="col-span-1 px-3">
                    <h4 class="text-[20px] sm:text-lg font-medium mt-7">Mobile</h4>
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img loading="lazy" src="assets/images/phone-1.png"
                                     class="w-full h-[75px] object-contain flex-shrink-0" alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">1</span>
                        ...
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">Xiaomi Note 7</h4>
                            </a>
                            <div class="font-medium">
                                <span class="text-primary mr-1">$45.00</span>
                                <span class="text-[#687188] text-sm font-medium line-through">$55.45</span>
                    ...
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img loading="lazy" src="assets/images/phone-2.png"
                                     class="w-full h-[75px] object-contain flex-shrink-0" alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">2</span>
                        ...
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">iPhone 11 max</h4>
                            </a>
                            <div class="font-medium">
                                <span class="text-primary mr-1">$45.00</span>
                                <span class="text-[#687188] text-sm font-medium line-through">$55.45</span>
                    ...
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img loading="lazy" src="assets/images/phone-3.png"
                                     class="w-full h-[75px] object-contain flex-shrink-0" alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">3</span>
                        ...
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">Oppo poco f1</h4>
                            </a>
                            <div class="font-medium">
                                <span class="text-primary mr-1">$45.00</span>
                                <span class="text-[#687188] text-sm font-medium line-through">$55.45</span>
                ...
                <div class="col-span-1 px-3">
                    <h4 class="text-[20px] sm:text-lg font-medium mt-[30px] sm:mt-7">Laptop</h4>
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img loading="lazy" src="assets/images/laptop-1.png"
                                     class="w-full h-[75px] object-contain flex-shrink-0" alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">1</span>
                        ...
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">Dell inspire 14</h4>
                            </a>
                            <div class="font-medium">
                                <span class="text-primary mr-1">$45.00</span>
                                <span class="text-[#687188] text-sm font-medium line-through">$55.45</span>
                    ...
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img loading="lazy" src="assets/images/laptop-2.png"
                                     class="w-full h-[75px] object-contain flex-shrink-0" alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">2</span>
                        ...
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">HP Omen 13</h4>
                            </a>
                            <div class="font-medium">
                                <span class="text-primary mr-1">$45.00</span>
                                <span class="text-[#687188] text-sm font-medium line-through">$55.45</span>
                    ...
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img loading="lazy" src="assets/images/laptop-3.png"
                                     class="w-full h-[75px] object-contain flex-shrink-0" alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">3</span>
                        ...
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">HP Pavilion 15</h4>
                            </a>
                            <div class="font-medium">
                                <span class="text-primary mr-1">$45.00</span>
                                <span class="text-[#687188] text-sm font-medium line-through">$55.45</span>
                ...
                <div class="col-span-1 pl-3 lg:hidden xl:block">
                    <h4 class="text-[20px] sm:text-lg font-medium mt-[30px] sm:mt-7">Headphones</h4>
                    <div class="sm:flex items-center mt-5">
                        <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                            <a href="#">
                                <img loading="lazy" src="assets/images/headphone-1.png"
                                     class="w-full h-[75px] object-contain flex-shrink-0" alt="product">
                            </a>
                            <span
                                class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">1</span>
                        ...
                        <div class="sm:pl-4 mt-3 sm:mt-0">
                            <a href="#">
                                <h4 class="text-base font-medium text-secondary mb-1.5">Bose Headphones</h4>
                            </a>
                            <div class="font-medium">
                                <span class="text-primary mr-1">$45.00</span>
                                <span class="text-[#687188] text-sm font-medium line-through">$55.45</span>
                    ...
                    <div class="sm:flex items-center mt-5">
                        ...
                        <div class="psm:pl-4 mt-3 sm:mt-0>
                            <a href=" # ">
                        <h4 class=" text-base font-medium text-secondary mb-1.5">COWIN E7 Active</h4>
                        </a>
                        <div class="font-medium">
                            <span class="text-primary mr-1">$45.00</span>
                            <span class="text-[#687188] text-sm font-medium line-through">$55.45</span>
                ...
                <div class="sm:flex items-center mt-5">
                    <div class="w-full sm:w-[105px] bg-[#F2F0F0] rounded-md p-2.5 relative">
                        <a href="#">
                            <img loading="lazy" src="assets/images/headphone-3.png"
                                 class="w-full h-[75px] object-contain flex-shrink-0" alt="product">
                        </a>
                        <span
                            class="absolute top-0 right-0 w-6 h-[18px] bg-primary text-center leading-5 text-white font-bold text-xs rounded-tr-md rounded-bl-md">3</span>
                    ...
                    <div class="sm:pl-4 mt-3 sm:mt-0">
                        <a href="#">
                            <h4 class="text-base font-medium text-secondary mb-1.5">Beats Headphones</h4>
                        </a>
                        <div class="font-medium">
                            <span class="text-primary mr-1">$45.00</span>
                            <span class="text-[#687188] text-sm font-medium line-through">$55.45</span>
    ...
    <div x-data class="container pb-14">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            <div class="col-span-1 overflow-hidden rounded-[3px] shadow-sm group">
                <div class="relative">
                    <img src="assets/images/product2.jpg" class="w-full object-cover flex-shrink-0" alt="product">
                    <div
                ...
                <div class="p-4">
                    ...
                    <p class="text-[15px] text-[#464545] mb-2.5">Outdoor Modular Lounge</p>
                    <div class="mr-[5px]">
                        <span class="text-primary text-xl font-semibold leading-[22px]">$449.00</span>
                    </div>
            ...
            <div class="col-span-1 overflow-hidden rounded-[3px] shadow-sm group">
                <div class="relative">
                    <img src="assets/images/product3.jpg" class="w-full object-cover flex-shrink-0" alt="product">
                    <div
                        class="w-[30px] h-[30px] bg-white text-base shadow-sm rounded-full absolute top-[15px] right-[15px] z-10 text-primary flex items-center justify-center cursor-pointer">
                        <svg width="26" height="26" viewBox="0 0 50 50">
                            <path fill="currentColor"
                ...
                <div class="p-4">
                    ...
                    <p class="text-[15px] text-[#464545] mb-2.5">Queen Bed</p>
                    <div class="mr-[5px]">
                        <span class="text-primary text-xl font-semibold leading-[22px]">$549.00</span>
                    </div>
                    <div class="flex items-center justify-start gap-[9px]">
                        <div class="flex items-center">
                            <span class="text-[#F6BC3E]"><svg width="17" height="17" viewBox="0 0 24 24">
                        ...
                        <p class="text-[15px] text-[#464545]">(52)</p>
                    </div>
                </div>
                <div class="w-full">
                    <button
            ...
            <div class="col-span-1 overflow-hidden rounded-[3px] shadow-sm group">
                <div class="relative">
                    <img src="assets/images/product4.jpg" class="w-full object-cover flex-shrink-0" alt="product">
                    <div
                        class="w-[30px] h-[30px] bg-white text-base shadow-sm rounded-full absolute top-[15px] right-[15px] z-10 text-primary flex items-center justify-center cursor-pointer">
                        <svg width="26" height="26" viewBox="0 0 50 50">
                            <path fill="currentColor"
                ...
                <div class="p-4">
                    ...
                    <p class="text-[15px] text-[#464545] mb-2.5">king Bed</p>
                    <div class="mr-[5px]">
                        <span class="text-primary text-xl font-semibold leading-[22px]">$549.00</span>
                    </div>
                    <div class="flex items-center justify-start gap-[9px]">
            ...
            <div class="col-span-1 overflow-hidden rounded-[3px] shadow-sm group">
                <div class="relative">
                    <img src="assets/images/product9.jpg" class="w-full object-cover flex-shrink-0" alt="product">
                    <div
                ...
                <div class="p-4">
                    ...
                    <p class="text-[15px] text-[#464545] mb-2.5">Queen Headboard</p>
                    <div class="mr-[5px]">
            ...
            <div class="col-span-1 overflow-hidden rounded-[3px] shadow-sm group">
                <div class="relative">
                    <img src="assets/images/product1.jpg" class="w-full object-cover flex-shrink-0" alt="product">
                    <div
                        class="w-[30px] h-[30px] bg-white text-base shadow-sm rounded-full absolute top-[15px] right-[15px] z-10 text-primary flex items-center justify-center cursor-pointer">
                        <svg width="26" height="26" viewBox="0 0 50 50">
                            <path fill="currentColor"
                ...
                <div class="p-4">
                    ...
                    <p class="text-[15px] text-[#464545] mb-2.5">Fabric Sofa Bed</p>
                    <div class="mr-[5px]">
            ...
            <div class="col-span-1 overflow-hidden rounded-[3px] shadow-sm group">
                <div class="relative">
                    <img src="assets/images/product8.jpg" class="w-full object-cover flex-shrink-0" alt="product">
                    <div
                ...
                <div class="p-4">
                    ...
                    <p class="text-[15px] text-[#464545] mb-2.5">Fabric Accent Chair</p>
                    <div class="mr-[5px]">
                        <span class="text-primary text-xl font-semibold leading-[22px]">$45.00</span>
                    </div>
                    <div class="flex items-center justify-start gap-[9px]">
            ...
            <div class="col-span-1 overflow-hidden rounded-[3px] shadow-sm group">
                <div class="relative">
                    <img src="assets/images/product10.jpg" class="w-full object-cover flex-shrink-0" alt="product">
                    <div
                        class="w-[30px] h-[30px] bg-white text-base shadow-sm rounded-full absolute top-[15px] right-[15px] z-10 text-primary flex items-center justify-center cursor-pointer">
                        <svg width="26" height="26" viewBox="0 0 50 50">
                            <path fill="currentColor"
            ...
            <div class="col-span-1 overflow-hidden rounded-[3px] shadow-sm group">
                <div class="relative">
                    <img src="assets/images/product12.jpg" class="w-full object-cover flex-shrink-0" alt="product">
                    <div
                        class="absolute top-[15px] left-[15px] p-2 rounded-[3px] bg-[#ffc107] text-[15px] text-white leading-[18px] z-10">
                        50%</div>
                    <div
                ...
                <div class="p-4">
                    ...
                    <p class="text-[15px] text-[#464545] mb-2.5">Black Bedside</p>
                    <div class="mr-[5px]">
                        <span class="text-primary text-xl font-semibold leading-[22px]">$400.00</span>
                    </div>
                    <div class="flex items-center justify-start gap-[9px]">
                        <div class="flex items-center">
                            <span class="text-[#F6BC3E]"><svg width="17" height="17" viewBox="0 0 24 24">
