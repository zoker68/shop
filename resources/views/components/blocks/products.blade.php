<div class="container pb-14">
    <div class="flex items-start justify-between mb-[30px]">
        ...
        <div class="pt-2">
            <a href="{{ $link['url'] }}" target="{{ $link['target'] }}" class="text-[15px] font-medium text-black hover:text-secondary flex items-center gap-1 hover:gap-3 transition-all duration-300">{{ $link['text'] }}
